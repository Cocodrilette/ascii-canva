import { Copy, Link, Shield, Users, Wifi, X } from "lucide-react";
        ...
        <div className="p-4 flex flex-col gap-4 bg-[var(--os-bg)]">
          <div className="window-sunken p-3 bg-white flex flex-col gap-2">
            <div className="flex justify-between items-center">
              <span className="ui-label text-xs uppercase opacity-70">Local Peer ID</span>
            ...
            <div className="flex justify-between items-center border-t border-gray-100 pt-2">
              <span className="ui-label text-xs uppercase opacity-70">Connection Status</span>
          ...
          {!channelId ? (
            <div className="flex flex-col gap-3">
              <p className="text-xs text-gray-600 leading-relaxed italic">
                Hosting a session allows you to share your ASCII canvas in real-time with others via WebRTC.
              </p>
              <button
                type="button"
                onClick={onStartHost}
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                <label className="ui-label">Shareable Link</label>
              ...
              <div className="p-2 border-2 border-dashed border-[var(--os-border-dark)] bg-blue-50/50 rounded flex items-start gap-2">
                ...
                <p className="text-[10px] text-blue-800 leading-tight">
                  Send this link to a peer. Once they open it, a secure P2P data channel will be established.
                </p>
              </div>
            </div>
          )}
