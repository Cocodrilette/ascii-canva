...
export interface LineElement extends BaseElement {
  type: "line";
  points: LinePoint[]; // points[0] is always {x, y} from BaseElement
...
export const lineExtension: AsciiExtension<LineElement, LineParams> = {
  type: "line",
  label: "Line",
  icon: Minus,

  create: (x: number, y: number, params?: LineParams) => {
  ...
  toAscii: (element, grid, offset) => {
    ...
    const nodes: LinePoint[] = rawNodes.filter((p, i, arr) => {
      if (i === 0) return true;
