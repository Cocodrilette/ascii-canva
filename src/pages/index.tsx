...
export default function Landing() {
  return (
    <div className="min-h-screen bg-[var(--os-bg)] flex items-center justify-center p-4">
      <Head>
      ...
      <div className="w-full max-w-3xl border-t-2 border-l-2 border-[var(--os-border-light)] border-r-2 border-b-2 border-[var(--os-border-dark)] bg-[var(--os-bg)] shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)]">
        {/* Title Bar */}
        <div className="bg-[var(--os-titlebar)] text-[var(--os-titlebar-text)] px-2 py-1 flex items-center justify-between font-['VT323'] text-sm">
          <div className="flex items-center gap-2">
            <Terminal size={14} />
            <span>ascii_canva_v1.0.exe</span>
          </div>
          <div className="flex gap-1">
            <button className="w-4 h-4 bg-[var(--os-bg)] border-t border-l border-[var(--os-border-light)] border-r border-b border-[var(--os-border-dark)] text-black flex items-center justify-center text-[10px]">_</button>
            <button className="w-4 h-4 bg-[var(--os-bg)] border-t border-l border-[var(--os-border-light)] border-r border-b border-[var(--os-border-dark)] text-black flex items-center justify-center text-[10px]">□</button>
            <button className="w-4 h-4 bg-[var(--os-bg)] border-t border-l border-[var(--os-border-light)] border-r border-b border-[var(--os-border-dark)] text-black flex items-center justify-center text-[10px]">✕</button>
          </div>
        </div>
        ...
        <div className="p-8 font-['MS_Sans_Serif'] text-[11px] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {/* Feature 1 */}
            <div className="p-4 border-t-2 border-l-2 border-[var(--os-border-dark)] border-r-2 border-b-2 border-[var(--os-border-light)] bg-white">
          ...
          <div className="flex flex-col items-center gap-4">
            <Link 
              href="/space" 
              className="px-8 py-3 bg-[var(--os-bg)] border-t-2 border-l-2 border-[var(--os-border-light)] border-r-2 border-b-2 border-[var(--os-border-dark)] hover:bg-gray-100 active:border-t-2 active:border-l-2 active:border-[var(--os-border-dark)] active:border-r-2 active:border-b-2 active:border-[var(--os-border-light)] font-['VT323'] text-xl uppercase tracking-widest flex items-center gap-2"
            >
              Initialize Workspace
            </Link>
            <div className="flex items-center gap-2 text-gray-600">
              <span className="w-2 h-2 bg-[var(--os-green)] animate-pulse rounded-full"></span>
              <span>System Ready. v1.0.42-STABLE</span>
            </div>
          </div>
        </div>

        {/* Status Bar */}
        <div className="border-t-2 border-[var(--os-border-dark)] p-1 px-2 flex justify-between text-[10px] uppercase font-bold text-gray-700 bg-[var(--os-bg)]">
